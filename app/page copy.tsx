        ...
        <div className="max-w-4xl w-full">
          ...
          <div className="text-center mb-6 animate-fade-in">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h1 className="text-5xl font-bold text-blue-950 bg-clip-text text-transparent">
                Decision Helper
              </h1>
            </div>
            ...
            <Card className="shadow-2xl bg-blue-950 backdrop-blur-xl animate-slide-up">
              ...
              <CardContent className="space-y-8">
                ...
                <Button
                  ...
                  className="w-full h-16 text-xl font-semibold bg-yellow-400 hover:bg-yellow-400 transition-all duration-300 transform hover:scale-110"
                  size="lg"
                >
                  {loading ? (
                    <>
            ...
            <Card className="shadow-2xl bg-blue-950 backdrop-blur-xl animate-slide-up">
                <CardHeader className="text-center">
                  <div className="w-full bg-blue-950 rounded-full h-2 mb-4">
                    <div
                      className="bg-gradient-to-r from-blue-200 to-blue-950 h-2 rounded-full transition-all duration-500"
                      ...
                      >
                        {questions[currentQuestion]?.answer_choices.map((choice, choiceIndex) => (
                          <div key={choiceIndex} className="group">
                            <div className="flex items-center space-x-4 p-4 rounded-xl border bg-blue-950 hover:bg-blue-200 transition-all duration-300 cursor-pointer">
                              <RadioGroupItem
                                value={choice}
                                id={`q${currentQuestion}-${choiceIndex}`}
                                className="border-blue-950 text-blue-200"
                              />
                              <Label
                  ...
                  <div className="flex gap-4">
                    ...
                    {currentQuestion < questions.length - 1 ? (
                      <Button
                        ...
                        className="flex-1 h-12 bg-yellow-400 hover:bg-yellow-400 hover:scale-110"
                      >
                        Next Question
            ...
            <div className="space-y-8 animate-slide-up">
              <Card className="shadow-2xl bg-blue-950 backdrop-blur-xl animate-slide-up">
                ...
                <CardContent className="space-y-8">
                  ...
                  <Button
                    onClick={resetForm}
                    className="w-full h-16 text-xl font-semibold bg-gradient-to-r from-blue-950 to-blue-200 transition-all duration-300 transform hover:scale-110"
                  >
